...
gcloud run deploy "${SERVICE_NAME}" \
    ...
    --update-secrets "GOOGLE_API_KEY=GOOGLE_API_KEY:latest,SERVICE_ACCOUNT_JSON=SERVICE_ACCOUNT_JSON:latest,UNSPLASH_ACCESS_KEY=UNSPLASH_ACCESS_KEY:latest,GOOGLE_OAUTH_CLIENT_ID=GOOGLE_OAUTH_CLIENT_ID:latest,GOOGLE_OAUTH_CLIENT_SECRET=GOOGLE_OAUTH_CLIENT_SECRET:latest,SESSION_SECRET_KEY=SESSION_SECRET_KEY:latest,STRIPE_SECRET_KEY=STRIPE_SECRET_KEY:latest,STRIPE_WEBHOOK_SECRET=STRIPE_WEBHOOK_SECRET:latest"
