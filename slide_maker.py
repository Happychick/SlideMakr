...
def create_presentation_from_audio(audio_data):
    """Create presentation from audio data"""
    try:
        # Transcribe audio
        instructions_text = transcribe_audio(audio_data)
        
        # Create presentation using instructions
        return create_presentation_from_instructions(instructions_text)
        
    except Exception as e:
        logging.error(f"Error creating presentation from audio: {e}")
